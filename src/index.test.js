...
import {
    ...
    onInitAppendTransaction, onUpdateAppendTransaction, applyNormalIfNoStyle, applyStyleForEmptyParagraph
} from './index';
...
describe('Style Plugin', () => {
    ...
    it('Remove CustomStyleByName if slice content is null', () => {
        ...
        view.state.plugins[0].props.handlePaste(handlePasteViewArg, null, mockSlice);
        view.state.plugins[0].props.handleDOMEvents.keydown(view, new KeyboardEvent('enter'));
...
describe('Cus Style Plugin-Pass', () => {
    ...
    it('should return newAttrs when RESERVED_STYLE_NONE  is nextLineStyle  ', () => {
        const newattrs = { align: 'left', color: null, id: '', indent: null, lineSpacing: null, paddingBottom: null, paddingTop: null, capco: null, styleName: 'A11-Rename' };
    ...
    it('should return newAttrs when RESERVED_STYLE_NONE  is not nextLineStyle  ', () => {
        jest.spyOn(CustStyl, 'getCustomStyleByName').mockReturnValue({ styles: { indent: 10, align: 'left', lineHeight: '10' } });
        const newattrs = { align: 'left', color: null, id: '', indent: null, lineSpacing: null, paddingBottom: null, paddingTop: null, capco: null, styleName: 'A11-Rename' };
    ...
    it('should return newAttrs when RESERVED_STYLE_NONE  is not nextLineStyle branch coverage  ', () => {
        jest.spyOn(CustStyl, 'getCustomStyleByName').mockReturnValue({ styles: { indent: 10, align: 'left', lineHeight: null } });
        const newattrs = { align: 'left', color: null, id: '', indent: null, lineSpacing: null, paddingBottom: null, paddingTop: null, capco: null, styleName: 'A11-Rename' };
        expect(setNodeAttrs('test', newattrs)).toStrictEqual({
            'align': 'left',
            'capco': null,
    ...
    it('should handle applyStyleForNextParagraph', () => {
        jest.spyOn(CustStyl, 'getCustomStyleByName').mockReturnValue({ styles: { indent: 10, align: 'left', lineHeight: null, nextLineStyleName: 'Normal' } });
        jest.spyOn(ccommand, 'getMarkByStyleName').mockReturnValue([{ type: 'mark-font-type', attrs: { name: 'Arial', overridden: false } }]);
        ...
        const prevstate = {
            schema: schema1, doc: schema1.nodeFromJSON({
                type: 'doc',
                attrs: {
                    layout: null,
                    padding: null,
        ...
        const nextstate = {
            schema: schema2, doc: schema2.nodeFromJSON({
                type: 'doc',
                attrs: {
                    layout: null,
                    padding: null,
        ...
        nextstate.tr = { setNodeMarkup: () => { return {}; } };
        ...
        transaction1.addStoredMark = (x) => { return {}; };
        transaction1.storedMarks = json.storedMarks;
        transaction1.setNodeMarkup = (a, b, c) => { return transaction1; };




        expect(applyStyleForNextParagraph(prevstate, nextstate, transaction1, mockview)).toBeDefined();
        const nextstate1 = {
            schema: schema2, doc: schema2.nodeFromJSON({
                type: 'doc',
                attrs: {
        ...
        expect(applyStyleForNextParagraph(prevstate1, nextstate1, transaction1, mockview)).toBeDefined();
        jest.spyOn(CustStyl, 'getCustomStyleByName').mockReturnValue({ styles: { indent: 10, align: 'left', lineHeight: null, nextLineStyleName: null } });
        expect(applyStyleForNextParagraph(prevstate1, nextstate1, transaction1, mockview)).toBeNull();
        expect(applyStyleForNextParagraph(prevstate1, nextstate1, null, mockview)).toBeDefined();
        expect(applyStyleForNextParagraph(prevstate1, nextstate1, null, null)).toBeDefined();
        expect(applyStyleForNextParagraph({}, {}, {}, { input: { lastKeyCode: 10 } })).toBeDefined();
        ...
        //const content = schema1.nodeFromJSON(yourJSON.doc);
        const prevstatemhod = {
            schema: schemamhod, doc: schemamhod.nodeFromJSON({
                type: 'doc',
                attrs: {
                    layout: null,
                    padding: null,
        ...
        expect(manageHierarchyOnDelete(prevstatemhod, nextstate, null, mockview2)).toBeDefined();
        const nextstatemhod = {
            schema: schema2, doc: schema2.nodeFromJSON({
                type: 'doc',
                attrs: {
        ...
        expect(manageHierarchyOnDelete(prevstatemhod, nextstatemhod, transaction1, mockview2)).toBeDefined();
    ...
    it('should handle manageHierarchyOnDelete when prevState.doc === nextState.doc', () => {
        expect(manageHierarchyOnDelete({ doc: 1 }, { selection: { from: 0 }, doc: 1 }, {}, {})).toBeDefined();
    });
...
describe('onUpdateAppendTransaction', () => {
    it('should handle onUpdateAppendTransaction when slice1 is null', () => {
        ...
        expect(onUpdateAppendTransaction({ firstTime: false }, { doc: mockdoc }, { selection: { $cursor: { pos: 0 }, $from: { before: () => { return 0; } }, $to: { after: () => { return 1; } } }, tr: { doc: { nodeAt: () => { return {}; } }, scrollIntoView: () => { return {}; } }, doc: mockdoc }, { selection: { $from: { before: () => { return 0; } }, $to: { after: () => { return 1; } } }, tr: { doc: { nodeAt: () => { return { key: 'tr' }; } } }, doc: mockdoc }, null, {}, null)).toBeDefined();
    });
    it('should handle onUpdateAppendTransaction when slice1 is null', () => {
        const linkmark = new Mark({
            name: 'link',
        ...
        expect(onUpdateAppendTransaction({ firstTime: false }, { doc: mockdoc, selection: { $from: { $start: () => { return 1; }, $end: () => { return 1; } } } }, { selection: { $cursor: { pos: 0 }, $from: { before: () => { return 0; }, $start: () => { return 1; }, $end: () => { return 1; } }, $to: { after: () => { return 1; } } }, tr: { doc: { nodeAt: () => { return {}; } }, scrollIntoView: () => { return {}; }, selection: { $from: { start: () => { return 1; }, end: () => { return 2; } } } }, doc: mockdoc }, { selection: { $from: { before: () => { return 0; } }, $to: { after: () => { return 1; } } }, tr: { doc: { nodeAt: () => { return { key: 'tr' }; } } }, doc: mockdoc }, { input: { lastKeyCode: 13 } }, {}, null)).toBeDefined();
    });
});

describe('applyStyleForEmptyParagraph', () => {
    it('applyStyleForEmptyParagraph', () => {
        expect(applyStyleForEmptyParagraph({ selection: { $from: { before: () => { return 1; } }, $to: { after: () => { return 2;; } } }, tr: { doc: { nodeAt: () => { return {}; } } } }, { doc: { nodeAt: () => { return {}; } } })).toBeDefined();
    });
});
