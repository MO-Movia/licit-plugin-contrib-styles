  ...
  buildStyle() {
    ...
    if (sampleDiv) {
      ...
      if (this.state.styles.boldPartial) {
        ...
        sampleDiv.appendChild(fragment);
      ...
      if (
        ...
        if (this.state.styles.boldNumbering) {
          ...
          sampleDiv.appendChild(boldElement);
        } else {
          sampleDiv.appendChild(numberingNode);
        }
    ...
    if (this.state.mode > 0 && this.isCustomStyleAlreadyApplied() && !isList) {
      ...
      this.setState((prevState) => ({
        ...
        styles: {
          ...
          styleLevel,
          isList,
          nextLineStyleName: isList ? prevState.styleName : RESERVED_STYLE_NONE,
        },
